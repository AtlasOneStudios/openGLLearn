...
void Shader::setVec4f(const std::string &name, float a, float b, float c, float d) const
{
    glUniform4fv(glGetUniformLocation(ID, name.c_str()), 1, glm::value_ptr(glm::vec4(a, b, c, d)));
}
